...
<head>
    ...
    <title>{{ config('app.name', 'SIJANTAN') }}</title>
...
<div class="flex flex-col sm:justify-center items-center sm:pt-0 bg-gray-100 h-full pb-5">
    <div
        class="container w-full mt-6 p-10 bg-white shadow-md overflow-hidden sm:rounded-lg">
        {{ $slot }}
    </div>
    ...
    <div class="container px-6 py-8 mx-auto">
        <div class="flex flex-col items-center text-center">
            ...
            <div class="flex flex-wrap justify-center mt-6 -mx-4">
                <a href="#"
                   class="mx-4 text-sm text-gray-600 transition-colors duration-300
