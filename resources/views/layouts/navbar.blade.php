<nav
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" class="flex items-center">
            <img src="{{asset('images/logopu.png')}}" class="h-8 mr-3" alt="Flowbite Logo">
            <span
        ...
        <div class="flex md:order-2">
            <a type="button" href="{{ route('login') }}"
               class="text-white bg-blue-700 rounded hover:bg-blue-800
                    focus:ring-4 focus:outline-none focus:ring-blue-300
                    font-medium text-sm px-6 py-2 text-center
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            ...
            md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800
            md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <a href="/"
                       class="block py-2 pl-3 pr-4 text-blue bg-blue-700
                       rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
                       aria-current="page">Home</a>
                </li>
                <li>
                    <a href="/peta"
                       class="block py-2 pl-3 pr-4 text-gray-900 rounded
                       ...
                       dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Peta</a>
                </li>
                <li>
                    <a href="/tentang"
                       ...
                       dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Tentang</a>
                </li>
            </ul>
        </div>
    </div>
